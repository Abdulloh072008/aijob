...
export const Navlist = ({ role }: NavlistProps) => {
  ...
  const links = role === "organization"
    ? [
        { label: "Dashboard", to: "/org/dashboard", icon: Home },
        { label: "Job Posts", to: "/org/jobs", icon: Briefcase },
        { label: "Applicants", to: "/org/applicants", icon: Users },
        { label: "Messaging", to: "/messages", icon: MessageSquare },
        { label: "Analytics", to: "/org/analytics", icon: PieChart },
      ]
    : [
